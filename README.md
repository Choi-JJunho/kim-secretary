...
- **직군별 평가**: 분류된 직군의 채용공고 기준으로 맞춤형 평가
- **동적 채용공고 스크래핑**:
  - 토스/카페24 채용공고를 실시간으로 동적 탐색
  - 키워드 기반 직군 분류로 새로운 공고도 자동 감지
  - 정적 job_id 대신 동적 탐색으로 사이트 변경에 유연하게 대응
  - 상세 페이지 URL 자동 추출 (공고 보기 클릭 없이 바로 이동)
- **100점 척도 평가**:
  - 핵심 기술 역량 (40점)
  - 문제 해결 능력 (25점)
  - 소프트 스킬 (20점)
...
- **추천 채용공고 링크**: 분류된 직군의 상세 채용 페이지로 바로 이동
...
│   │   ├── scraper.py          # 토스 채용공고 스크래퍼 (동적 탐색)
│   │   ├── scraper_cafe24.py   # 카페24 채용공고 스크래퍼 (동적 탐색)
